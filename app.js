...
const usersFilePath = dirname + '/users.json';
app.get('/', (req, res) => {
res.sendFile( dirname + '/option.html');
});
...
res.send('<center> <h3> Register successful. Now you can <a
href="/">login</a>. </h3> </center>');
});
...
if (user) {
res.send(`<center> <h1>Welcome, ${user.firstname}</h1> </center>`);
} else {
